...
class ParamsWindow(customtkinter.CTkToplevel):
    ...
    def __init__(self, out_queue, current_input_device, current_output_device):
        super().__init__()
        ...
        self.input_label = customtkinter.CTkLabel(self, text='Input device:', width=100, anchor='w')
        ...
        self.output_label = customtkinter.CTkLabel(self, text='Output device:', width=100, anchor='w')
        ...
        self.scaling_label = customtkinter.CTkLabel(self, text='UI Scaling:', width=100, anchor='w')
        self.scaling_label.grid(row=2, column=0, padx=(label_left_pad, 5), pady=(5, vertical_pad))
        ...
        self.scaling_optionemenu.grid(row=2, column=1, padx=(0, 10), pady=(5, vertical_pad))
